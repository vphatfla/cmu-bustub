...
| Task #4 | External Merge Sort + Limit Executors + Window Functions (ExternalMergeSort ✅, Limit ✅, TupleComparator+GenerateSortKey ✅, WindowFunction ✅) | ✅ `p3.20-window-function.slt` passes (2026-08-09) — pending p3.18/19 integration regression check for full Task #4 credit |
...
Not yet run: `p3.18-integration.slt` / `p3.19-integration.slt` regression check (needed for full Task #4 credit alongside `p3.20`).
